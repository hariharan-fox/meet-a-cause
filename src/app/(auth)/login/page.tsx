      ...
      <div className="flex min-h-screen items-center justify-center px-4">
        <Card className="w-full max-w-sm">
          <CardHeader className="text-center">
            ...
            <CardDescription>Log in to your Meet A Cause account.</CardDescription>
          </CardHeader>
          <CardContent>
            <Form {...form}>
                  ...
                  <FormItem>
                    <div className="flex items-center justify-between">
                      ...
                      <DialogTrigger asChild>
                        <Button variant="link" className="ml-auto text-sm underline h-auto p-0">
      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        {isResetSent ? (
          <div className="py-8 text-center space-y-4">
            ...
            <p className="text-muted-foreground text-sm">Don&apos;t forget to check your spam folder.</p>
